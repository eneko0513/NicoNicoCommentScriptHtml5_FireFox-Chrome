javascript: (function (f, dd) {
	...
	[コンポーネント, CSSの配置]
	----------------------------------------------------------------------------------------------------*/
	$('div.MainContainer').after("<style type='text/css'>" +
		".tab_wrap{" +
		"  margin:10px auto;" +
		"  }" +
		"  input[type='radio']{" +
		...
		"	</label>		" +
		"	<label id='tab4_2' class='tab4_label' for='tab4'>Version:2.1.0" +
		"	</label>		" +
		"  </div>		" +
		...
		"			<option value='small_ue_full_gothic_W68_L38'>small 38 full</option>" +
