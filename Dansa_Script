...
$('myTxtOut').onclick = function(){
	...
	var w //= 34*12; //あとでWから取得するように
	var l //= 16; //あとでlから取得するように
	var e;//計算用
	var f;
	var n = [];//長さ、左空白幅格納配列
	var nd = [];//処理用
	...
	//左空白削り
	p = Math.floor(n[0].LEFTSPACE/12) * 12
